...
import com.weather.spring.cloud.initializrstart.service.WeatherReportService;
...
public class ReportController
{
    ...
    public ModelAndView getReportListByCityId(@PathVariable("cityId") String cityId,Model model){
        ...
        List<City> cityList = weatherReportService.getAllCityData().getCityList();
        /*get the city weather info*/
        Weather weather = weatherReportService.getWeatherByCityId(cityId);
